...
// Route::post('/get_laporan_sp_cvs/{tgl}/{sales}', 'LaporanCvsDompulController@getData');
// Route::get('/laporan-penjualan/sp-cvs/{tgl_penjualan}/{sales}', 'LaporanCvsDompulController@data');
//Persediaan

...
class CreateDetailPembayaranPembelianDompulsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('detail_pembayaran_pembelian_dompuls', function (Blueprint $table) {
            $table->increments('id_detail_pembayaran_dompul');
            $table->integer('id_pembelian_dompul');
    ...
    {
        Schema::dropIfExists('detail_pembayaran_pembelian_dompuls');
    }
}

...
<div class="modal fade" id="verificationModal">
  <div class="modal-dialog">
    <div class="modal-content">
      <form action="{{ url('/') }}/pembelian/sp/list/verify" method="POST" id="verificationForm">
        @csrf @method('put')
...
<div class="modal fade" id="deleteModal">
  <div class="modal-dialog">
    <div class="modal-content">
      <form id="deleteForm" action="{{ url('/') }}/pembelian/sp/list/delete" method="POST">
        @csrf @method('put')
...
<script>
    $(function () {
        ...
        var t = $('#list-invoice-table').DataTable({
            ...
            ajax: `{{ url('/') }}/pembelian_sp/list/${$tgl_pembelian}`,
            columns: [
                // {data: 'indeks'},
        ...
        $('#show').on('click',function (event) {
          ...
          t.ajax.url(`{{ url('/') }}/pembelian_sp/list/${$tgl}`).load();
          console.log('Loaded');
        });

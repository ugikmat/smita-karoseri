...
@section('content_header')
    <h1>Laporan Pembelian Dompul</h1>
...
<table id="l-beli-dompul-table" class="table responsive" width="100%">
    <thead>
    <tr>
        <th>No</th>
        <th>Nama Supplier</th>
  ...
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      ...
      <div class="modal-header">
        ...
        <h4 class="modal-title" id="myModalLabel">Input Laporan Pembelian Dompul</h4>
      </div>
                ...
                <form id="editForm" method="POST" data-parsley-validate class="form-horizontal form-label-left" action="">
                  ...
                  <div class="form-group">
                    <div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
                      ...
                      <button type="button" id="save" class="btn btn-success" data-dismiss="modal"><i class="glyphicon glyphicon-ok"></i>Tampilkan Laporan Pembelian Dompul</button>
                    </div>
                  </div>
                </form>
              </div>
  ...
  $.ajaxSetup({
    ...
    $(function () {
        ...
        var t = $('#l-beli-dompul-table').DataTable({
            ...
            ajax: `/smita/pembelian/laporan-pembelian/dompul/data/${$tgl}`,
            "columnDefs": [ {
            "searchable": false,
            "orderable": false,
            "targets": 0
        ...
        $.post(`/smita/pembelian/get_laporan_dompul/${$tgl}`, function(response){
            if(response.success)
            {
              console.log('Success..');
        ...
        $('#save').on('click',function(event) {
          $tgl = $('#tgl').val();
          t.ajax.url(`/smita/pembelian/laporan-pembelian/dompul/data/${$tgl}`).load();
          $.post(`/smita/pembelian/get_laporan_dompul/${$tgl}`, function(response){
            if(response.success)
            {
              console.log('Success..');

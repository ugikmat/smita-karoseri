  ...
  $.ajaxSetup({
    ...
    $(function () {
        ...
        var t = $('#l-beli-dompul-table').DataTable({
            ...
            ajax: `{{ url('/') }}/pembelian/laporan-pembelian/dompul/data/${$tgl}`,
            "columnDefs": [ {
            "searchable": false,
            "orderable": false,
            "targets": 0
        ...
        $.post(`{{ url('/') }}/pembelian/get_laporan_dompul/${$tgl}`, function(response){
            if(response.success)
            {
              console.log('Success..');
        ...
        $('#save').on('click',function(event) {
          $tgl = $('#tgl').val();
          t.ajax.url(`{{ url('/') }}/pembelian/laporan-pembelian/dompul/data/${$tgl}`).load();
          $.post(`{{ url('/') }}/pembelian/get_laporan_dompul/${$tgl}`, function(response){
            if(response.success)
            {
              console.log('Success..');

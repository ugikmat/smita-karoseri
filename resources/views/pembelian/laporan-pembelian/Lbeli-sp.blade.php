  ...
  $.ajaxSetup({
    ...
    $(function () {
        ...
        var t = $('#l-beli-sp-table').DataTable({
            ...
            stateSave: true,
            ajax: `/pembelian/laporan-pembelian/sp/data/${$tgl}`,
            "columnDefs": [ {
            "searchable": false,
            "orderable": false,
            "targets": 0
        ...
        $.post(`/pembelian/get_laporan_sp/${$tgl}`, function(response){
            if(response.success)
            {
              console.log('Success..');
        ...
        $('#save').on('click',function(event) {
          $tgl = $('#tgl').val();
          t.ajax.url(`/pembelian/laporan-pembelian/sp/data/${$tgl}`).load();
          $.post(`/pembelian/get_laporan_sp/${$tgl}`, function(response){
            if(response.success)
            {
              console.log('Success..');

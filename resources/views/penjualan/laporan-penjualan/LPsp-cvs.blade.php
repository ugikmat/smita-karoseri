  ...
  $.ajaxSetup({
    ...
    $(function () {
        ...
        var t = $('#lp-sp-table').DataTable({
            ...
            stateSave: true,
            scrollX: true,
            ajax: `/smita/laporan-penjualan/sp-cvs/${$tgl}/${$sales}`,
            columnDefs: [
                {
        ...
        $.post(`/smita/get_laporan_sp_cvs/${$tgl}/${$sales}`, function(response){
            if(response.success)
            {
        ...
        $('#save').on('click',function(event) {
          $tgl = $('#tgl').val();
          $sales = $('#sales').val();
          t.ajax.url(`/smita/laporan-penjualan/sp-cvs/${$tgl}/${$sales}`).load();
          $.post(`/smita/get_laporan_sp_cvs/${$tgl}/${$sales}`, function(response){
            if(response.success)
            {
              console.log('Success..data');

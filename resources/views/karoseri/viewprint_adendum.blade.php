       ...
       <table style="margin-left:10px; margin-right:10px;">
         ...
         <tr>
           <td colspan="10"><center><b>SURAT PEMESANAN KAROSERI</b><br><br></td>
                 ...
                 <tr>
                 <td style="padding-left:10px" width="120px" >No.SPK</td>
                 <td width="10px">:</td>
                 <td width="450px"> <b>ADENDUM<b>/1000/SPK/VII/2018</td>
                 <td><label>12 Juli 2018<br><br></td>
                 </tr>
                 ...
                 <td width="10px">:</td>
                 <td width="450px">PT Maju Mundur</td>
                 <td></td>
                 </tr>
                 ...
                 <tr>
                 <td style="padding-left:10px" width="120px" >Harga/unit</td>
                 <td width="10px">:</td>
                 <td width="45px"><label>Rp.</label>50.000.000</td>
                 <td></td>
                 </tr>

                 <tr>
                 <td style="padding-left:10px" width="120px">PPN(10%)</td>
                 <td width="10px">:</td>
                 <td width="450px"><label>Rp.</label>0</td>
                 <td></td>
                 </tr>

                 <tr>
                 <td style="padding-left:10px" width="120px">Total</td>
                 <td width="10px">:</td>
                 <td width="450px"><label>Rp.</label>50.000.000</td>
                 <td></td>
                 </tr>

                 <tr>
                 <td style="padding-left:10px;" valign="top" width="120px" >Cara Pembayaran</td>
                 <td valign="top" width="10px">:</td>
                 <td width="450px">DP 50% diawal. 50% sebelum serah terima unit<br><strong><label>BCA Cabang Kartini Gresik</label><br><label>a/n: CV Wijawa Baru, a/c: 7900890707</label></strong></td>
                 <td></td>
                 </tr>

                 <tr>
                 <td  style="padding-left:10px; " width="120px" >Detail Spesifikasi</td>
                 <td width="10px">:</td>
                 <td width="450px">Menggunakan besi tahan karat</td>
                 <td></td>
                 </tr>

                 <tr>
                    <td colspan="3" style="padding-left:10px"><b><br>*Serah terima unit karoseri dilakukan setelah pembayaran 100% lunas.</td>
                 </tr>

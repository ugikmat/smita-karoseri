...
@section('content_header')
    <h1>Laporan Progress Pekerjaan Pemborong</h1>
...
<ol class="breadcrumb">
  ...
  <li class="active">Progress Pekerjaan Pemborong</li>
</ol>
...
<div class="form-group">
  <label class="col-md-6 col-sm-6 col-xs-12">Tanggal SPKPB<span class="required"></span></label>
...
$('#excel').on('click', function(){
  window.open('printProgressPBExcel/xlsx?param_a=' + $('input[name="tanggal_awal"]').val() + '&param_b=' + $('input[name="tanggal_akhir"]').val(),'_blank')
})

...
@section('content_header')
    <h1>Laporan Penjualan Tiap Customer</h1>
...
<ol class="breadcrumb">
  ...
  <li class="active">Penjualan Karoseri Tiap Customer</li>
</ol>
...
<script>
  ...
  $('#excel').on('click', function(){
    window.open('printPenjualanExcel/xlsx?param_a=' + $('input[name="tanggal_awal"]').val() + '&param_b=' + $('input[name="tanggal_akhir"]').val(),'_blank')
  })

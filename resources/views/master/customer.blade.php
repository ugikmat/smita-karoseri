          ...
          <div class="row">
            <div class="col-md-12 col-sm-12 col-xs-12">
              <div class="x_panel">
                ...
                <div class="x_content">
                  <br />
                  <form method="post" data-parsley-validate class="form-horizontal form-label-left" action="{{ url('/') }}/customer">
                    @csrf
          ...
          <div class="col-md-12 col-sm-12 col-xs-12">
            <div class="x_panel">
              ...
              <div class="x_content">
                ...
                <!--Modal EDIT-->
                <form id="editForm" method="post" data-parsley-validate class="form-horizontal form-label-left" action="{{ url('/') }}/customer">
                  @csrf @method('put')
...
<script>
  $('#editModal').on('show.bs.modal', function (event) {
    ...
    var modal = $(this)
    $('#editForm').attr('action', `{{ url('/') }}/customer/${id}`);

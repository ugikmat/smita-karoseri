          ...
          <div class="row">
            <div class="col-md-12 col-sm-12 col-xs-12">
              <div class="x_panel">
                ...
                <div class="x_content">
                  <br />
                  <form method="post" data-parsley-validate class="form-horizontal form-label-left" action="/operasional/smita/gudang">
                    @csrf
                    ...
                    <div class="form-group">
                      <label class="control-label col-md-3 col-sm-3 col-xs-12" for="first-name">Nama Gudang
                        <span class="required">*</span>
                      </label>
                      <div class="col-md-6 col-sm-6 col-xs-12">
              ...
              <div class="x_content">
                ...
                <form id="editForm" method="post" data-parsley-validate class="form-horizontal form-label-left" action="">
                  ...
                  <div class="form-group nama_gudang">
                    ...
                    <div class="col-md-6 col-sm-6 col-xs-12">
                      <input type="text" id="alamat_gudang_upt" required="required" name="alamat_gudang_upt" class="form-control col-md-7 col-xs-12"
                        value="">
                    </div>
                  </div>
...
<script>
  ...
  $('#editModal').on('show.bs.modal', function (event) {
    ...
    $('#editForm').attr('action', `/operasional/smita/gudang/${id}`);
  ...
  $('#deleteModal').on('show.bs.modal', function (event) {
    ...
    // If necessary, you could initiate an AJAX request here (and then do the updating in a callback).
    // Update the modal's content. We'll use jQuery here, but you could use a data binding library or other methods instead.
    $('#deleteForm').attr('action', `/operasional/smita/gudang/${id}`);
  })
</script>

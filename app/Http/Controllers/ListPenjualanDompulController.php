                          ...
                          ->addColumn('action', function ($penjualanDompul) {
                              if ($penjualanDompul->status_pembayaran==0) {
                                  if(Auth::user()->level_user!='Supervisor'||Auth::user()->level_user!='Super Admin'){
                                    ...
                                    href="/smita/penjualan/dompul/list-invoice/edit/'.$penjualanDompul->id_penjualan_dompul.'/'.$penjualanDompul->nm_sales.'/'.$penjualanDompul->tanggal_penjualan_dompul.'/'.$penjualanDompul->nm_cust.'">

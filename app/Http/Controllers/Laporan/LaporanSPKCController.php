...
class LaporanSPKCController extends Controller
{
    /**
    ...
    public function printExcel($type, Request $request)
      ...
      if($awal == '' && $akhir == ''){
  		...
  		return Excel::create('Laporan SPKC', function($excel) use ($data) {
  			$excel->sheet('LaporanSPKC', function($sheet) use ($data)
  	        {
